    ...
    return (
       ...
       {/* Title  */}
            <div className='md:flex bg-gray-100'>
                ...
                <div className='m-5 space-y-5 px-5 bg-gray-100 border rounded-2xl'>    
               
                <Image src="/banner-photo.jpg" width={300} height={300} alt='banner image'></Image>
               <div className='text-center rounded-2xl bg-white'>
                 <h1 className='text-2xl'>Hello, I'm Aysha Noor Tithi</h1>
                <h5>Social Media Manager</h5>
                <p className='font-bold'>BANGLADESH</p>
               </div>
               </div>
            <div className='w-full flex flex-col items-center justify-center space-y-4 m-2 bg-gray-100 rounded-2xl'>
                <div className=' rounded-md w-full text-start p-4  '>
                    <h1 className='text-3xl  text-pink-400 text-justify'>{text}</h1>
                </div>
