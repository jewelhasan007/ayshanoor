...
const page = () => {
    return (
        <div className='space-y-3 m-3 p-3'>
            ...
            <p className='flex items-center'><IoMdMail className='mr-3 text-2xl'></IoMdMail> Mail: <Link href='mailto:*****@gmail.com'><span className='text-red-500 mx-2'>*****@gmail.com</span> </Link> </p>
            <p className='flex items-center'> <FaWhatsapp className='mr-3 text-2xl'></FaWhatsapp>  Whatsapp: <span className='text-green-400 font-bold mx-2'> 01*********</span>  </p>
